...
> **Guía histórica del piloto de libreta y taza.** Para el estado vigente
> usar [piloto actual](../piloto-demo.md) y [operación](../operacion.md).
> Las instrucciones, rutas, límites y despliegues de abajo describen etapas
> anteriores. No repetir altas ni sustituir la demo de uniformes siguiendo
> esta guía. La antigua plantilla `prompts/demo.md` está ahora en
> `prompts/plantillas/cliente_demo.md`.
